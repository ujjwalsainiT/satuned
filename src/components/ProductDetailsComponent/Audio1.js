    ...
    AUDIO.VISUALIZER = (function () {
        ...
        Visualizer.prototype.bindEvents = function () {
            ...
            document.addEventListener('click', function (e) {
                console.log("isPlay", _this.isPlaying);
        ...
        Visualizer.prototype.loadSound = function () {
            ...
            this.canvasCtx.fillText('by ' + this.author, this.canvas.width / 2 + 10, this.canvas.height / 2);
...
const handelStart = () => {
//    const aa =  document.getElementById("myAudio")
//   aa.play()
history.push("/products/1")
  ...
  return (
    ...
    <p className="text-danger" onClick={handelStart}>OKK</p>
      </div>
    </div>
  );
};
